    ...
    begin
        if "No." = '' then begin
            if "Payment Type" = "payment type"::Normal then begin   //Cheque Payments
                ...
                "No." := NoSeries.GetNextNo(GenLedgerSetup."Payment Voucher Nos")

            end;
            if "Payment Type" = "payment type"::"Cash Purchase" then begin       //Cash Payments
                GenLedgerSetup.Get;
                GenLedgerSetup.TestField(GenLedgerSetup."Cash Voucher Nos");
                "No." := NoSeries.GetNextNo(GenLedgerSetup."Cash Voucher Nos");
            end;
            if "Payment Type" = "payment type"::"Petty Cash" then begin      //PettyCash Payments
                GenLedgerSetup.Get;
                GenLedgerSetup.TestField(GenLedgerSetup."PettyCash Nos");
                "No." := NoSeries.GetNextNo(GenLedgerSetup."PettyCash Nos");
            ...
            if "Payment Type" = "payment type"::Mobile then begin        //Mobile Payments
                GenLedgerSetup.Get;
                GenLedgerSetup.TestField(GenLedgerSetup."Mobile Payment Nos");
                "No." := NoSeries.GetNextNo(GenLedgerSetup."Mobile Payment Nos");
